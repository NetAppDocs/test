...
Change for localization. Enable docbot and test loc display. Testing docbot disablement. Re-testing ruby upgrade for a third time. Test see all results label translation.
