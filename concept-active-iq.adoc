...
Change for localization. Enable docbot and test loc display. Testing docbot disablement. Re-testing ruby upgrade for a third time. Re-test see all results label translation.
